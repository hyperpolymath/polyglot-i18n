...
(define-module (polyglot-i18n meta)
...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "Project requires foundational architecture decisions before development can proceed. Need to establish CI/CD, security practices, and code standards.")
...
(define development-practices
  '((code-style
     (languages . ("Ada" "Dockerfile" "JavaScript" "Julia" "Just" "Nickel" "Nix" "ReScript" "Rust" "Scheme" "Shell" "Tree-sitter Query"))
     (formatter . "gnatpp")
     (linter . "gnatcheck")
     (line-length . 100)
     (indent . "spaces")
